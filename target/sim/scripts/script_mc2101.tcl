...
if {[string equal -nocase $sim "VIVADO"]} { #If the simulation environment is VIVADO
  ...
  add_wave -into {GPIO} {/tb_mc2101/microcontroller/MC2101_1/GPIO} 
  add_wave -into {GPIO} {/tb_mc2101/microcontroller/MC2101_1/GPIO/periph_gpio/core/busDataIn} 
  add_wave -into {GPIO} {/tb_mc2101/microcontroller/MC2101_1/GPIO/periph_gpio/core/address} 
  add_wave -into {GPIO} {/tb_mc2101/microcontroller/MC2101_1/GPIO/periph_gpio/core/gpio_pad_dir} 
  add_wave -into {GPIO} {/tb_mc2101/microcontroller/MC2101_1/GPIO/periph_gpio/core/gpio_out_sync}
  add_wave -into {GPIO} {/tb_mc2101/microcontroller/MC2101_1/GPIO/periph_gpio/core/PADDIR} 
  add_wave -into {GPIO} {/tb_mc2101/microcontroller/MC2101_1/GPIO/periph_gpio/core/PADIN} 
  add_wave -into {GPIO} {/tb_mc2101/microcontroller/MC2101_1/GPIO/periph_gpio/core/PADOUT} 
  add_wave -into {GPIO} {/tb_mc2101/microcontroller/MC2101_1/GPIO/periph_gpio/core/PADEN} 
  add_wave -into {GPIO} {/tb_mc2101/microcontroller/MC2101_1/GPIO/periph_gpio/core/PADINTEN} 
  add_wave -into {GPIO} {/tb_mc2101/microcontroller/MC2101_1/GPIO/periph_gpio/core/INTTYPE0} 
  add_wave -into {GPIO} {/tb_mc2101/microcontroller/MC2101_1/GPIO/periph_gpio/core/INTTYPE1} 
  add_wave -into {GPIO} {{/tb_mc2101/microcontroller/MC2101_1/GPIO/periph_gpio/gpio_core_en}} 
