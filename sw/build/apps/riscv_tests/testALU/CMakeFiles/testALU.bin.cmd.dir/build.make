...
apps/riscv_tests/testALU/testALU.bin: apps/riscv_tests/testALU/testALU.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating testALU.bin"
	cd /media/sf_Shared/pulpino/sw/build/apps/riscv_tests/testALU && /opt/riscv/bin/riscv32-unknown-elf-objcopy -R .debug_frame -R .comment -R .stack -R .heapsram -R .heapscm -R .scmlock -O binary /media/sf_Shared/pulpino/sw/build/apps/riscv_tests/testALU/testALU.elf testALU.bin
...
apps/riscv_tests/testALU/CMakeFiles/testALU.bin.cmd.dir/clean:
	cd /media/sf_Shared/pulpino/sw/build/apps/riscv_tests/testALU && $(CMAKE_COMMAND) -P CMakeFiles/testALU.bin.cmd.dir/cmake_clean.cmake
