...
apps/riscv_tests/testExceptions/CMakeFiles/testExceptions.vsimc:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Running testExceptions in ModelSim"
	cd /media/sf_Shared/pulpino/sw/build/apps/riscv_tests/testExceptions && /usr/bin/cmake -E remove stdout/*
	cd /media/sf_Shared/pulpino/sw/build/apps/riscv_tests/testExceptions && /usr/bin/cmake -E remove FS/*
	cd /media/sf_Shared/pulpino/sw/build/apps/riscv_tests/testExceptions && tcsh -c env\ VSIM_DIR=/media/sf_Shared/pulpino/vsim\ USE_ZERO_RISCY=0\ RISCY_RV32F=0\ ZERO_RV32M=0\ ZERO_RV32E=0\ PL_NETLIST=\ TB_TEST=""\ /opt/intelFPGA/20.1/modelsim_ase/linuxaloem/vsim\ \ -c\ -64\ -do\ 'source\ tcl_files/run.tcl\;\ run\ -a\;\ exit\;'\ >vsim.log
	cd /media/sf_Shared/pulpino/sw/build/apps/riscv_tests/testExceptions && tail -n +1 -- ./stdout/*
...
apps/riscv_tests/testExceptions/CMakeFiles/testExceptions.vsimc.dir/clean:
	cd /media/sf_Shared/pulpino/sw/build/apps/riscv_tests/testExceptions && $(CMAKE_COMMAND) -P CMakeFiles/testExceptions.vsimc.dir/cmake_clean.cmake
