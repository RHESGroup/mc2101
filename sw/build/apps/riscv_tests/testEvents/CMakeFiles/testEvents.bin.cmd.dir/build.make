...
apps/riscv_tests/testEvents/testEvents.bin: apps/riscv_tests/testEvents/testEvents.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating testEvents.bin"
	cd /media/sf_Shared/pulpino/sw/build/apps/riscv_tests/testEvents && /opt/riscv/bin/riscv32-unknown-elf-objcopy -R .debug_frame -R .comment -R .stack -R .heapsram -R .heapscm -R .scmlock -O binary /media/sf_Shared/pulpino/sw/build/apps/riscv_tests/testEvents/testEvents.elf testEvents.bin
...
apps/riscv_tests/testEvents/CMakeFiles/testEvents.bin.cmd.dir/clean:
	cd /media/sf_Shared/pulpino/sw/build/apps/riscv_tests/testEvents && $(CMAKE_COMMAND) -P CMakeFiles/testEvents.bin.cmd.dir/cmake_clean.cmake
