...
apps/riscv_tests/official/rv_official.bin: apps/riscv_tests/official/rv_official.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating rv_official.bin"
	cd /media/sf_Shared/pulpino/sw/build/apps/riscv_tests/official && /opt/riscv/bin/riscv32-unknown-elf-objcopy -R .debug_frame -R .comment -R .stack -R .heapsram -R .heapscm -R .scmlock -O binary /media/sf_Shared/pulpino/sw/build/apps/riscv_tests/official/rv_official.elf rv_official.bin
...
apps/riscv_tests/official/CMakeFiles/rv_official.bin.cmd.dir/clean:
	cd /media/sf_Shared/pulpino/sw/build/apps/riscv_tests/official && $(CMAKE_COMMAND) -P CMakeFiles/rv_official.bin.cmd.dir/cmake_clean.cmake
