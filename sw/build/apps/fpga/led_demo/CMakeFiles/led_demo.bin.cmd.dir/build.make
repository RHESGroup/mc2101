...
apps/fpga/led_demo/led_demo.bin: apps/fpga/led_demo/led_demo.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating led_demo.bin"
	cd /media/sf_Shared/pulpino/sw/build/apps/fpga/led_demo && /opt/riscv/bin/riscv32-unknown-elf-objcopy -R .debug_frame -R .comment -R .stack -R .heapsram -R .heapscm -R .scmlock -O binary /media/sf_Shared/pulpino/sw/build/apps/fpga/led_demo/led_demo.elf led_demo.bin
