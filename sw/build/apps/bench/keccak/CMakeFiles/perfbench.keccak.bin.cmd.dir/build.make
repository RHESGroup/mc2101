...
apps/bench/keccak/perfbench.keccak.bin: apps/bench/keccak/perfbench.keccak.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating perfbench.keccak.bin"
	cd /media/sf_Shared/pulpino/sw/build/apps/bench/keccak && /opt/riscv/bin/riscv32-unknown-elf-objcopy -R .debug_frame -R .comment -R .stack -R .heapsram -R .heapscm -R .scmlock -O binary /media/sf_Shared/pulpino/sw/build/apps/bench/keccak/perfbench.keccak.elf perfbench.keccak.bin
...
apps/bench/keccak/CMakeFiles/perfbench.keccak.bin.cmd.dir/clean:
	cd /media/sf_Shared/pulpino/sw/build/apps/bench/keccak && $(CMAKE_COMMAND) -P CMakeFiles/perfbench.keccak.bin.cmd.dir/cmake_clean.cmake
