...
apps/bench/fft/perfbench.fft.bin: apps/bench/fft/perfbench.fft.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating perfbench.fft.bin"
	cd /media/sf_Shared/pulpino/sw/build/apps/bench/fft && /opt/riscv/bin/riscv32-unknown-elf-objcopy -R .debug_frame -R .comment -R .stack -R .heapsram -R .heapscm -R .scmlock -O binary /media/sf_Shared/pulpino/sw/build/apps/bench/fft/perfbench.fft.elf perfbench.fft.bin
...
apps/bench/fft/CMakeFiles/perfbench.fft.bin.cmd.dir/clean:
	cd /media/sf_Shared/pulpino/sw/build/apps/bench/fft && $(CMAKE_COMMAND) -P CMakeFiles/perfbench.fft.bin.cmd.dir/cmake_clean.cmake
