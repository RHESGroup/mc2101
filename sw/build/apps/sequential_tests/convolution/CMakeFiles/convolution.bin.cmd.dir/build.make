...
apps/sequential_tests/convolution/convolution.bin: apps/sequential_tests/convolution/convolution.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating convolution.bin"
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/convolution && /opt/riscv/bin/riscv32-unknown-elf-objcopy -R .debug_frame -R .comment -R .stack -R .heapsram -R .heapscm -R .scmlock -O binary /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/convolution/convolution.elf convolution.bin
...
apps/sequential_tests/convolution/CMakeFiles/convolution.bin.cmd.dir/clean:
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/convolution && $(CMAKE_COMMAND) -P CMakeFiles/convolution.bin.cmd.dir/cmake_clean.cmake
