...
apps/sequential_tests/motion_detection/motion_detection.bin: apps/sequential_tests/motion_detection/motion_detection.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating motion_detection.bin"
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/motion_detection && /opt/riscv/bin/riscv32-unknown-elf-objcopy -R .debug_frame -R .comment -R .stack -R .heapsram -R .heapscm -R .scmlock -O binary /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/motion_detection/motion_detection.elf motion_detection.bin
...
apps/sequential_tests/motion_detection/CMakeFiles/motion_detection.bin.cmd.dir/clean:
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/motion_detection && $(CMAKE_COMMAND) -P CMakeFiles/motion_detection.bin.cmd.dir/cmake_clean.cmake
