...
apps/sequential_tests/dct/dct.bin: apps/sequential_tests/dct/dct.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating dct.bin"
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/dct && /opt/riscv/bin/riscv32-unknown-elf-objcopy -R .debug_frame -R .comment -R .stack -R .heapsram -R .heapscm -R .scmlock -O binary /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/dct/dct.elf dct.bin
...
apps/sequential_tests/dct/CMakeFiles/dct.bin.cmd.dir/clean:
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/dct && $(CMAKE_COMMAND) -P CMakeFiles/dct.bin.cmd.dir/cmake_clean.cmake
