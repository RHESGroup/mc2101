...
apps/sequential_tests/pooling/pooling.bin: apps/sequential_tests/pooling/pooling.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating pooling.bin"
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/pooling && /opt/riscv/bin/riscv32-unknown-elf-objcopy -R .debug_frame -R .comment -R .stack -R .heapsram -R .heapscm -R .scmlock -O binary /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/pooling/pooling.elf pooling.bin
...
apps/sequential_tests/pooling/CMakeFiles/pooling.bin.cmd.dir/clean:
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/pooling && $(CMAKE_COMMAND) -P CMakeFiles/pooling.bin.cmd.dir/cmake_clean.cmake
