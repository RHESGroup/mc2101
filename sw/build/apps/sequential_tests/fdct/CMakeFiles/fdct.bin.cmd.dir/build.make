...
apps/sequential_tests/fdct/fdct.bin: apps/sequential_tests/fdct/fdct.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating fdct.bin"
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/fdct && /opt/riscv/bin/riscv32-unknown-elf-objcopy -R .debug_frame -R .comment -R .stack -R .heapsram -R .heapscm -R .scmlock -O binary /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/fdct/fdct.elf fdct.bin
...
apps/sequential_tests/fdct/CMakeFiles/fdct.bin.cmd.dir/clean:
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/fdct && $(CMAKE_COMMAND) -P CMakeFiles/fdct.bin.cmd.dir/cmake_clean.cmake
