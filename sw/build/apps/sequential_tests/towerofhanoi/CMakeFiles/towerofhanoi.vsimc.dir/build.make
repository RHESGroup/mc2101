...
apps/sequential_tests/towerofhanoi/CMakeFiles/towerofhanoi.vsimc:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Running towerofhanoi in ModelSim"
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/towerofhanoi && /usr/bin/cmake -E remove stdout/*
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/towerofhanoi && /usr/bin/cmake -E remove FS/*
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/towerofhanoi && tcsh -c env\ VSIM_DIR=/media/sf_Shared/pulpino/vsim\ USE_ZERO_RISCY=1\ RISCY_RV32F=0\ ZERO_RV32M=1\ ZERO_RV32E=0\ PL_NETLIST=\ TB_TEST=""\ /opt/intelFPGA/20.1/modelsim_ase/linuxaloem/vsim\ \ -c\ -64\ -do\ 'source\ tcl_files/run.tcl\;\ run\ -a\;\ exit\;'\ >vsim.log
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/towerofhanoi && tail -n +1 -- ./stdout/*
...
apps/sequential_tests/towerofhanoi/CMakeFiles/towerofhanoi.vsimc.dir/clean:
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/towerofhanoi && $(CMAKE_COMMAND) -P CMakeFiles/towerofhanoi.vsimc.dir/cmake_clean.cmake
