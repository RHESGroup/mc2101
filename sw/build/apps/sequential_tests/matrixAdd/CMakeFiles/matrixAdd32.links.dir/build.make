...
apps/sequential_tests/matrixAdd/matrixAdd32/modelsim.ini:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating matrixAdd32/modelsim.ini"
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/matrixAdd && /usr/bin/cmake -E create_symlink /media/sf_Shared/pulpino/vsim/modelsim.ini /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/matrixAdd/matrixAdd32/modelsim.ini

apps/sequential_tests/matrixAdd/matrixAdd32/work:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Generating matrixAdd32/work"
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/matrixAdd && /usr/bin/cmake -E create_symlink /media/sf_Shared/pulpino/vsim/work /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/matrixAdd/matrixAdd32/work

apps/sequential_tests/matrixAdd/matrixAdd32/tcl_files:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Generating matrixAdd32/tcl_files"
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/matrixAdd && /usr/bin/cmake -E create_symlink /media/sf_Shared/pulpino/vsim/tcl_files /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/matrixAdd/matrixAdd32/tcl_files

apps/sequential_tests/matrixAdd/matrixAdd32/waves:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_4) "Generating matrixAdd32/waves"
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/matrixAdd && /usr/bin/cmake -E create_symlink /media/sf_Shared/pulpino/vsim/waves /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/matrixAdd/matrixAdd32/waves
...
apps/sequential_tests/matrixAdd/CMakeFiles/matrixAdd32.links.dir/clean:
	cd /media/sf_Shared/pulpino/sw/build/apps/sequential_tests/matrixAdd && $(CMAKE_COMMAND) -P CMakeFiles/matrixAdd32.links.dir/cmake_clean.cmake
